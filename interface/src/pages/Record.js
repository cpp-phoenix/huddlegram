    ...
    return (
        <div className='text-white'>
            ...
            <div className='w-full flex flex-row justify-center space-x-24 mt-8'>
                <button className='rounded-lg px-4 py-4 bg-blue-500 hover:bg-blue-600 text-white'  onClick={() => huddleIframeApp.methods.startRecording({uploadToIpfs: true})}>Start Recording</button>
           </div>
        </div>
    )
}
