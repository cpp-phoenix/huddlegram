...
function Search() {
    ...
    const ProfileTab = () => {
        return (
            <div className="flex flex-col items-center w-full h-full text-white  space-y-4">
    ...
    return (
        <div className="flex flex-col items-center w-full h-[710px] text-white bg-black">
            <div className="flex flex-row space-x-4 my-4 ">
                <label class="relative block">
                    ...
                    <input onChange={(e) => {setSearchKey(e.target.value)}}   class="text-black placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for username..." type="text" name="search"/>
                </label>
